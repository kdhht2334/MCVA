...
class MultiSimilarityLoss(GenericPairLoss):
    ...
    def _compute_loss(self, mat, pos_mask, neg_mask, ref_pos, ref_neg):
        ...
        pos_loss = (1.0/self.alpha) * lmu.logsumexp_ref(-self.alpha * (mat - self.base), keep_mask=pos_mask, add_one=True, ref=ref_pos)
        neg_loss = (1.0/self.beta) * lmu.logsumexp_ref(self.beta * (mat - self.base), keep_mask=neg_mask, add_one=True, ref=ref_neg)
